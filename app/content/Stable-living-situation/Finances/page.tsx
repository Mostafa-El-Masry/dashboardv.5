...
const Finances = () => {
  return (
    ...
    <ul>
      <li>
        1st Way to achieve this is to work in KUWAIT for 6 Months saving 250K.d a month.<br />
        total of 1500K.d spending 500 on your visa and 400 on vication salary and 200 on gifts and air tickets.<br />
        and 600 to buy your self some time to find new work.<br />
        <strong>Sugessted on your first year of marriage.</strong>
      </li>
      <li>
    ...
    <ul>
      ...
      <li>
        ...
        60,000EGP to savings for my vacation <br />
